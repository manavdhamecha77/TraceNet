    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-white dark:bg-slate-800/55 border border-slate-200 dark:border-slate-700 p-6 rounded-md shadow-sm max-w-xl mx-auto space-y-6 mt-8">
        <div className="text-center space-y-3">
          ...
          <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">CLIP Vector Indexing (Phase 3)</h3>
          <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-sm mx-auto">
            Once Phase 2 extracts coordinate tracklets, Phase 3 will compile CLIP vectors to enable open-vocabulary queries, e.g., 
